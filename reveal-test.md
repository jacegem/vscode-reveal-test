...
![An image](https://cdn-images-1.medium.com/max/800/1*1WcQFRiBaqAxbmxsRKmrRQ.jpeg)<!-- .element: style="float: left; width: 45%" class="fragment fade-up"-->

![An image](https://cdn-images-1.medium.com/max/800/1*1WcQFRiBaqAxbmxsRKmrRQ.jpeg)<!-- .element: style="float: right; width: 45%" -->
...
<!-- .slide: data-background="https://images.pexels.com/photos/719609/pexels-photo-719609.jpeg" -->
...
```markdown
<!-- .slide: data-background="https://images.pexels.com/photos/719609/pexels-photo-719609.jpeg" data-background-repeat="repeat" data-background-size="100px" -->
```
